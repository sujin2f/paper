...
export const Hypothesis = (): JSX.Element => (
    <Doc>
        ...
        <p>
            This document begins with a single question. According to quantum
            physics, matter exists as a probability. However, is the probability
            space truly empty and devoid of meaning? What if that space is
