    ...
    return (
        <Fragment>
            ...
            <p>
                ...
                than what we know before. Mass becomes the space that we knew as
                a probability cloud. The photon is a similar thing with a
                sparkle inside the ether. Energy absorbed into an atom preserves
            ...
            <p>
                ...
                inside the tunnel? Each tunnel contains the divided ethers, and
                the sparkle would travel through the spaces. I expect one ether
                should be disappeared. Otherwise, our world will be full of
            ...
            <p>
                What is a sparkle? Ether cannot travel more than the speed of
                light because the mass will be increased and become like a black
                hole, and the sparkle will be stopped eventually. Therefore, the
                independent sparkle, the light, can fly at the speed of light.
                In the other words, the sparkle has the property, named time.
                Time is not the property of our universe. It is the property of
            ...
            <p>
                ...
                the sparkle will be changed, and it is related to its time. Time
                is not in our universe. We, the matter, have the time. Each
                sparkle might have a different time due to the ether's weight.
                This may be the reason that the atomic clock is so accurate. An
                atom has its own time. Time is the part of an atom.
            </p>
            <h3>
            ...
            <p>
                ...
                double-slit. The sparkle inside it travel the divided ether
                freely. One ether is divided from our dimension, but they are
                connected. I suggest carefully the entanglement comes from the
                feature of the ether.
            </p>
            <h3>Follow-Ups</h3>
            <p>
                In the multi-electron atom, the Rydberg tends to follow a
                certain formula. If I found the exact formula to find Rydberg of
                radial and linear, I would be able to calculate the overall
                value by adding.
            </p>
            [Fin]
        </Fragment>
