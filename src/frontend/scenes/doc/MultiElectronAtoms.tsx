    ...
    return (
        <Fragment>
            ...
            <p>
                ...
                and m<sub>l</sub>. The electron's energy, n, increases the
                number of the node. The angular momentum, l, changes the shape
                of the node to linear. Let me ignore the magnetic quantum
                number, m<sub>l</sub>, which changes the angle of the orbital.
            </p>
            <p>
                The s orbital is an orbital that only has radial nodes. When
                there is no node, it is s1, and s2 has one radial node. The p
                orbital has one linear node. One linear node is p2, and one
                linear and one radial node is p3. Under this rule, scientists
                named d, f, and g orbital based on how many linear nodes the
                orbital has.
            </p>
            ...
            <p>
                ...
                the number of ethers, and increasing l changes the shape of the
                ether. The s orbital only has radial ethers, and the p orbital
                has one linear ether. The s1 orbital means the electron does not
                have any ether, and p3 orbital has one radial and one linear
                ether.
            </p>

            <p>
                The orbital has been understood to change the shape of an
                electron. Under my hypothesis, the electron is not changed, but
                its space is separated by the photon-ether likewise it is
                separated by the double-slit. If so, the electron-sparkle
                travels through the separated electron-ether, which is divided
                by the photon-ether, and the existence of the electron-sparkle
                exists in probability. This is what orbital is.
            </p>
            ...
            <p>
                ...
                mention the hydrogen is to check the accuracy of NIST data and
            ...
            <p>
                ...
                same, so it is extremely accurate. As we already know, the value
                meets N<sub>th</sub>(n), but we still can see the small
                differences.
            </p>
            ...
            <p>
                ...
                hydrogen atom. Scientists say this is because of the influence
            ...
            <p>
                ...
                of approximately 100%p. The d and f orbitals are higher than N
                <sub>th</sub>(n), and others are lower. By increasing the
                position, it tends to close to N<sub>th</sub>(n), but the
                diagonal changes are not matched to each other. Moreover, it is
                not convincing why the changes of two and three linear ether, d
                and f, are different from other changes. The table is too
                irregular. There is no tendency. End of the story. Bye.
            </p>

            <p>What if the way we think is wrong?</p>

            <p>
                Let me recheck the 3p orbital. It should be different between
                [O-] and [-O] because the radial and linear ether affect
                differently in different positions. [-] is 107.933, and [O] is
                102.031, so [-O] should not be the same as [O-]. However, the 3p
                value from NIST is always the same. Therefore, only one case is
                right.
            </p>

            <p>
                When I constructed the table, I accepted the s and p orbital
                which is linear ether first. What if it is the opposite? What if
                the radial ether first, and then the linear ether comes above
                the radial ether?
            </p>
            ...
            <p>
                ...
                increment of linear ethers. So, we need to compare other rows
                with linear ether. They go down and close to the N<sub>th</sub>
                (n).
            </p>
            ...
            <p>
                The first linear ether has a high Rydberg vale, the second is
                minus, and from the third, it converges to N<sub>th</sub>(n). It
                seems to be possible to make functions, and the overall Rydberg
                would be calculated.
            </p>

            <p>
                On the other hand, it has a rule, and I can say the condition of
                the ether-sparkle hypothesis is compromised.
            </p>

            <p>
                It explains how the radial ether increased and how the linear
                ether was added above the radial ether. The orbital is not an
                electron shape. The node is photon-ether, and the orbital is
                electron ether, divided by the photon-ether.
            </p>

            <p>
                The table above is the percentage point. The Rydberg of the
                position is in the table below. Now I changed the digit from 1
                because we do not need s1 which means no ether.
            </p>
            ...
            <p>
                ...
                magnesium. I assure you it is possible to find the rule or
            ...
            <p>
                ...
                <sub>th</sub>(n). It would be possible to figure out the rule of
                stacking radial ethers per atomic number.
            </p>
