...
$$E_th = \frac{ℏ^2}{2 \mu a_0 ^ 2}N_n \hspace{20pt} \\\{ n \geqq 2 \\\}$$
...
<p align="center">표2-7. 준위차에 따른 빛-에테르 에너지 값 (eV)</p>
...
이 x값을 식2-5에 대입하는 것으로 지름 파동함수의 해를 구할 수 있다. 먼저 y(x)를 다시 rR(r)로 되돌린다. 아래에서 A는 정규화 상수이다. 0에서 무한대의 적분값을 1로 놓아 얻을 수 있다.
