...
우리는 `L`항의 `n-l-1` 부분이 항상 `1`이 되는 것으로 가정해서 제거했다. 따라서 오차의 보정은 `x^l`항에서 일어나게 될 것이다. 그렇다면 자연스럽게 `l`이 의미하는 바가 새롭게 정의될 것이다. 위에서 정의한 `Nn`까지 적용해서 `Rth`를 다시 써보기로 하겠다.

$$x = \frac{2r}{a_0} \sqrt{N_{th}(n_{th}) \frac{1}{n_{th}}}$$
...
$$x = \frac{2r}{a_0} \sqrt{N_{th}(n_{th}) \frac{1}{n_{th} - 1}}$$
...
$$(\frac{2j + k + 1}{2})^2 = N_n \frac{1}{n-1}$$

$$\to \frac{2j + 2l + 2}{2} = \sqrt{N_n \frac{1}{n-1}}$$

$$\to j + l + 1 = \sqrt{N_n \frac{1}{n-1}}$$

$$\to l = \sqrt{N_n \frac{1}{n-1}} - (j + 1)$$
...
$$\to l = \sqrt{N_n \frac{1}{n-1}} - \frac{1}{(n-1)^2}$$

$$\to l = \sqrt{N_{th} \frac{1}{n_{th}}} - \frac{1}{(n_{th})^2}$$

이것을 `Rth`에 대입하기로 한다.

$$x = \frac{2r}{a_0} \sqrt{N_{th}(n_{th}) \frac{1}{n_{th} - 1}}$$

$$R_{th}(r, n_{th}) = Ae^{-\frac{x}{2}} x^{\sqrt{N_{th} \frac{1}{n_{th}}} - \frac{1}{(n_{th})^2}} L_{1}^{1}(x)$$

$$R_{th}(r, n_{th}) = Ae^{-\frac{x}{2}} x^{\sqrt{N_{th} \frac{1}{n_{th}}} - \frac{1}{(n_{th})^2}}$$
