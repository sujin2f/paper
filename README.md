...
<p align="center">식2-9. 지름 파동함수 R(r)</p>

우리가 구하려는 것은 n당 오비탈의 마디 한 개이다. 따라서 라게르 다항식의 밑은 언제나 1인 것으로 가정하자. 이를 만족시키기 위한 수식은 나중에 돌아볼 기회를 만들도록 하겠다. 또한 우리는 이 단계에서 l=0인 경우만 생각할 것이다. 최종적인 형태의 파동함수는 다음과 같다.
